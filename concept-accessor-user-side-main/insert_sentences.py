...
def normalize_text(text):
    text = text.lower()
    text = re.sub(r'[^a-zA-Z0-9]', '', text)  # remove spaces + special chars
    return text
...
# 🔹 Main function
def store_sentences(input_text, chapter_id=None):
    if not chapter_id:
        chapter_id = f"chapter_e36b81d0_7c842520"
    ...
    if documents:
        ...
        print(f"✅ Inserted {len(documents)} sentences")
    else:
...
which were based on natural affinities among the organisms and consider,not only the external features, but also internal features, like ultra-
...
used by taxonomists these days.Algae are chlorophyll-bearing, simple, thalloid, autotrophic and largely
...
gamete is termed oogamous, e.g., Volvox, Fucus.Algae are useful to man in a variety of ways. At least a half of the total
...
Chlorophyceae, Phaeophyceae and Rhodophyceae.The members of chlorophyceae are commonly called green algae. The
...
(Figure 3.1a).The members of phaeophyceae or brown algae are found primarily in
...
Laminaria, Sargassum and Fucus (Figure 3.1b).The members of rhodophyceae are commonly called red algae because of
...
Porphyra (Figure 3.1c), Gracilaria and Gelidium.Bryophytes include the various mosses and liverworts that are found
commonly growing in moist shaded areas in the hills (Figure 3.2).Bryophytes are also called amphibians of the plant kingdom because
...
spores. These spores germinate to produce gametophyte.Bryophytes in general are of little economic importance but some
...
into liverworts and mosses.The liverworts grow usually in moist, shady habitats such as banks of
...
form new individuals. During sexual reproduction, male and female sex organs are produced either on the same or on different thalli. The
...
free-living gametophytes.The predominant stage of the life cycle of a moss is the gametophyte which
...
(Figure 3.2).The Pteridophytes include horsetails and ferns. Pteridophytes are used
...
and Pteropsida (Dryopteris, Pteris, Adiantum).The gymnosperms (gymnos : naked, sperma : seeds) are plants in which
...
help to reduce water loss.The gymnosperms are heterosporous; they produce
...
megasporangium.Unlike bryophytes and pteridophytes, in
gymnosperms the male and the female gametophytes
do not have an independent free-living existence. They remain within the sporangia retained on the
sporophytes. The pollen grain is released from the
Dwarf
microsporangium. They are carried in air currents and come in contact with the opening of the ovules borne
on megasporophylls. The pollen tube carrying the male
gametes grows towards archegonia in the ovules and discharge their contents near the mouth of the archegonia. Following fertilisation, zygote develops into
an embryo and the ovules into seeds. These seeds are not covered. Unlike the gymnosperms where the ovules are naked, in the angiosperms
...
shown in Figure 3.6. In plants, both haploid and diploid cells can divide by
mitosis. This ability leads to the formation of different plant bodies - haploid and diploid. The haploid plant body produces gametes by mitosis. This plant body represents a gametophyte. Following fertilisation the zygote also divides by mitosis to produce a diploid
sporophytic plant body. Haploid spores are produced
by this plant body by meiosis. These in turn, divide by
mitosis to form a haploid plant body once again. Thus, during the life cycle of any sexually reproducing plant, there is an alternation of generations between gamete
producing haploid gametophyte and spore producing
diploid sporophyte. However, different plant groups, as well as individuals
...
represent this pattern (Figure 3.7 a).On the other extreme, is the type wherein the diploid sporophyte is the dominant, photosynthetic, independent phase of the plant. The gametophytic phase is represented by the single to few-celled haploid gametophyte. This kind of life cycle is termed as diplontic. An alga, Fucus sp., represents this pattern (Fig. 3.7b). In addition, all seed bearing plants i.e., gymnosperms and angiosperms, follow this pattern with some variations, wherein, the
gametophytic phase is few to multi-celled. Bryophytes and pteridophytes, interestingly, exhibit
an intermediate condition (Haplo-diplontic); both
phases are multicellular. However, they differ in their dominant phases.A dominant, independent, photosynthetic, thalloid or erect phase is
