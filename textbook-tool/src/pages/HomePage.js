...
//             <p>AI adapts content to your pace and understanding.</p>
//           </div>

//           <div className="feature-card">
//             <span>📊</span>
//             <h3>Visual Explanations</h3>
//             <p>Concept maps, diagrams, and labeled images.</p>
//           </div>

//           <div className="feature-card">
//             <span>⚡</span>
//             <h3>Save Time</h3>
//             <p>Understand faster without reading every page.</p>
//           </div>

//           <div className="feature-card">
//             <span>🌐</span>
//             <h3>Multi-Language</h3>
//             <p>Translate content to Indian regional languages.</p>
//           </div>

//           <div className="feature-card">
//             <span>🧠</span>
//             <h3>Smart Analysis</h3>
//             <p>Word, sentence, summary & Q/A modes.</p>
//           </div>

//           <div className="feature-card">
//             <span>📘</span>
//             <h3>Interactive PDFs</h3>
//             <p>Click concepts directly inside the PDF.</p>
//           </div>
//         </div>
//       </section>
